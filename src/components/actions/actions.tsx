...
const DynamicApplyCancelAction = dynamic(() =>
  import("@/components/actions/apply-cancel-action").then(
    (mod) => mod.ApplyCancelAction
  )
);
const DynamicApplyPostponeAction = dynamic(() =>
  import("@/components/actions/apply-postpone-action").then(
    (mod) => mod.ApplyPostponeAction
  )
);
const DynamicDeleteAction = dynamic(() =>
  import("@/components/actions/delete-action").then((mod) => mod.DeleteAction)
);
const DynamicEditAction = dynamic(() =>
  import("@/components/actions/edit-action").then((mod) => mod.EditAction)
);
const DynamicReplyCancellationAction = dynamic(() =>
  import("@/components/actions/reply-cancellation-action").then(
    (mod) => mod.ReplyCancellationAction
  )
);
const DynamicReplyPostponeAction = dynamic(() =>
  import("@/components/actions/reply-postpone-action").then(
    (mod) => mod.ReplyPostponeAction
  )
);
const DynamicFinishAction = dynamic(() =>
  import("@/components/actions/finish-action").then((mod) => mod.FinishAction)
);
const DynamicTakeOrderAction = dynamic(() =>
  import("@/components/actions/take-order-action").then(
    (mod) => mod.TakeOrderAction
  )
);
const DynamicUpdateStatusAction = dynamic(() =>
  import("@/components/actions/update-status-action").then(
    (mod) => mod.UpdateStatusAction
  )
);
