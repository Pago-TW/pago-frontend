...
> = {
  consumer: {
    ...
    TO_BE_DELIVERED: { text: "商品已購買，等待交付", bgColor: "primary.500" },
    DELIVERED: { text: "商品已送達", bgColor: "primary.500" },
    FINISHED: { text: "訂單已完成", bgColor: "success.500" },
    CANCELED: { text: "此訂單不成立", bgColor: "warning.500" },
  },
  shopper: {
